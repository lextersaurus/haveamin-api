...
const { getCategories, getOneCategory,createCategory, updateCategory, deleteCategory, quitEventCategory, addEventCategory } = require('../controllers/category.controller')
